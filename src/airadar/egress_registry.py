...
CALLSITE_REGISTRY = (
    ...
    Callsite("src/airadar/egress.py", "httpx.Client", 1, "egress-port-probe"),
    ...
    Callsite("src/airadar/eval/aihot_fit/common.py", "subprocess.run", 2, "local-git-process"),
    Callsite("src/airadar/eval/aihot_fit/governance.py", "subprocess.run", 1, "local-process"),
    ...
    Callsite("src/airadar/interpret/engine/embedding.py", "gateway_client", 1, "loopback-explicit-direct"),
    Callsite("src/airadar/interpret/engine/summarizer/llm.py", "gateway_client", 1, "loopback-explicit-direct"),
    Callsite("src/airadar/interpret/engine/summarizer/fetcher.py", "selector_httpx_client", 1, "selector-owned"),
    ...
    Callsite("src/airadar/provider/codex_gpt_mini.py", "gateway_client", 1, "loopback-explicit-direct"),
    Callsite("src/airadar/provider/deepseek_chat.py", "gateway_client", 1, "loopback-explicit-direct"),
    Callsite("src/airadar/provider/llm_gateway.py", "OpenAI", 1, "loopback-explicit-direct"),
    Callsite("src/airadar/provider/llm_gateway.py", "httpx.Client", 1, "loopback-explicit-direct"),
    ...
    Callsite("scripts/eval/build_body_overlay.py", "selector_httpx_client", 1, "selector-owned"),
    Callsite("scripts/eval/measure_live_composition.py", "open_external_url", 1, "selector-owned"),
    Callsite("scripts/eval/measure_live_composition.py", "urlopen", 1, "compatibility-wrapper"),
    Callsite("scripts/eval/measure_archive_composition.py", "subprocess.run", 1, "local-git-process"),
    Callsite("scripts/eval/measure_curated_composition.py", "subprocess.run", 3, "local-git-process"),
    ...
    Callsite("tests/playwright/conftest.py", "socket.socket", 1, "loopback-explicit-direct"),
    Callsite("tests/playwright/test_aihot_source_alignment.py", "socket.socket", 1, "loopback-explicit-direct"),
...
AUDIT_CALLSITE_REGISTRY = (
    ...
    AuditCallsite("src/airadar/interpret/engine/embedding.py", "interpret.engine.embeddings"),
    AuditCallsite("src/airadar/interpret/engine/summarizer/llm.py", "interpret.engine.chat"),
    AuditCallsite("src/airadar/interpret/engine/summarizer/fetcher.py", "interpret.engine.fetch_url"),
    ...
    AuditCallsite("scripts/eval/build_body_overlay.py", "scripts.eval.build_body_overlay"),
    AuditCallsite("scripts/eval/measure_live_composition.py", "scripts.eval.measure_live_composition"),
