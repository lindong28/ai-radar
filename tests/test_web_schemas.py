...
MODEL_FIELD_SNAPSHOTS = {
    FeedItem: {
        ...
        "primary_category",
        "is_opinion",
        "classification_projection_status",
        "classification_projection_authority",
...
FEED_ITEM_FIXTURE = {
    ...
    "is_opinion": False,
    "classification_projection_status": "exact",
    "classification_projection_authority": "candidate_v2",
    "classification_projection_evidence": ["candidate_authority_v2"],
    "reasoning": "Reasoning",
