...
新题库（object-specific-v2）的[设计与建题规则](../../../docs/evaluations/benchmarks/visible-score/aihot-visible-score/object-specific-v2/README.md)已独立于共同窗口；[重建/扩展命令](../../../docs/evaluations/benchmarks/object-datasets.md)使用 scripts/build_eval_datasets.py。下文 evaluate.py 是历史 v1 全池运行入口，明确拒绝 v2，避免将独立题库误当完整池。
