...
- 输出：项目根 `runs/content-enrichment/aihot-enrichment/<version>/<UTC-date>/<UTC-time>/` 与同分区 `experiments/`；当前进展见[status](../../../docs/evaluations/objects/content-enrichment/status.md)。
