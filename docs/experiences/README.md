...
> 按 topic 分文件。每个文件内 append-only。

| Topic | 文件 | 简述 |
|---|---|---|
| Performance | [performance.md](./performance.md) | 性能优化相关的坑点和 pattern |
| Frontend | [frontend.md](./frontend.md) | 前端开发相关的坑点和 pattern |
...
| Measurement | [measurement.md](./measurement.md) | 读数可不可信：仪器失明（同形失败）、对照与内部一致性检查 |
