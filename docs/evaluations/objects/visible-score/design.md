...
2026-09-18 已认可的[逐对象独立建题规则](../../benchmarks/visible-score/aihot-visible-score/aihot-original-v3/README.md)覆盖本页旧题库准入条件，允许在缺少 Radar raw 时显式接入 AIHOT 原标题与绑定原文。下文保留 v1 推理/指标语义；新题库与旧全池执行器的边界以新版说明为准。
