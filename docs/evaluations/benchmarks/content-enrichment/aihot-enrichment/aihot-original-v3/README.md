...
2026-09-18 修订：同来源 URL 配对及输入版本按[实质性规则](../../../object-datasets.md#实质内容版本与-url-身份2026-09-18-用户修订)。富化只核原标题和正文的实质差异，不因发布时间、HTML、来源标签或未使用的作者字段变化而排题；参考字段冲突规则不变。旧版本保持原样，当前数据版本见库存。
