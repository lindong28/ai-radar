...
| 槽位 | 设计与当前能力 |
| --- | --- |
| ① 优化对象 | reason-first 六维 scorer＋固定普通展示公式为历史基线；2026-09-21 起[优先还原作者公开的五维判断＋代码组合机制](status.md#当前方向作者公开机制优先)，具体维度和公式仍待研究。已测[三维语义候选](semantic-design.md)与直接总分保留为对照，数值校准保留为历史诊断。现有运行、失败保留和归档已接通，不表示新五维候选已经实现；生产未替换。 |
